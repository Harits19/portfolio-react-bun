  ...
  return (
    ...
    >
      <div className="gap-y-12 mt-12 flex flex-col">
        {work.map(({ desc, image, link, name, skill }) => {
          return (
            <div className="flex flex-row rounded-xl overflow-hidden shadow-lg h-[480px]">
              <div className="w-[576px] h-full p-12 bg-light-gray-50 dark:bg-dark-gray-50">
                <img
                  src={image}
                  className="h-full w-full object-cover object-left rounded-lg shadow-md"
                />
              </div>
